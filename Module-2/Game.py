...
TownOrField = input('Would you like to enter the town to your right or to the forest on the left?').lower()
if TownOrField == 'right':
    ...
    Dungeon = input('Would you like to go to the dungeon?').lower()
    if Dungeon == 'yes':
...
Quest = input('Natsu asks if you want to do a quest for him?')
if Quest == 'yes':
    ...
    print('You encountered the Red Dragon Emperor! Prepare to attack!') 
...
Asta = input('Do you respect him or laugh at him?')
if Asta == 'laugh':
